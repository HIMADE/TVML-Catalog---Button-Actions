  ...
  <listTemplate>
    <list>
      ...
      <section>
        ...
        <listItemLockup>
          <img src="${this.BASEURL}resources/images/iceland/iceland_1_square_shrunk.jpg" width="90" height="90" />
          <title>Square</title>
        </listItemLockup>
        <listItemLockup>
          <img src="${this.BASEURL}resources/images/iceland/iceland_4_poster_shrunk.jpg" width="76" height="135" />
          <title>Poster</title>
        </listItemLockup>
        <listItemLockup>
          <img src="${this.BASEURL}resources/images/iceland/iceland_3_poster_shrunk.jpg" width="76" height="135" />
          <title>Title</title>
          <subtitle>Subtitle</subtitle>
        </listItemLockup>
        <listItemLockup style="margin: 0 0 0 -5">
          <img src="${this.BASEURL}resources/images/iceland/iceland_4_shrunk.jpg" width="280" height="187" />
          <title>Title</title>
        </listItemLockup>
      </section>
      <section>
