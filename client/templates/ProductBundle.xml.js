...
<document>
  ...
  <productBundleTemplate>
    <background>
      <img src="${this.BASEURL}resources/images/uber_background.png" />
      <audio>
    ...
    <banner>
      <stack>
        <title></title>
        <subtitle>Worshiping Jehovah as One</subtitle>
        <text>Text</text>
    ...
    <shelf>
      ...
      <section>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_520_e1.lcr" width="250" height="250" />
          <title class="showTextOnHighlight">Title 1</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_520_e2.lcr" width="250" height="250" />
          <title class="showTextOnHighlight">Title 2</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_520_e3.lcr" width="250" height="250" />
          <title class="showTextOnHighlight">Title 3</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_520_e4.lcr" width="250" height="250" />
          <title class="showTextOnHighlight">Title 4</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_520_e5.lcr" width="250" height="250" />
          <title class="showTextOnHighlight">Title 5</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_520_e6.lcr" width="250" height="250" />
          <title class="showTextOnHighlight">Title 6</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_520_e7.lcr" width="250" height="250" />
