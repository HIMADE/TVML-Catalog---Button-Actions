  ...
  <descriptiveAlertTemplate>
    ...
    <shelf>
      <section>
        ...
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_570_e2.lcr" width="450" height="450" />
          <title class="showTextOnHighlight">Title 2</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_570_e3.lcr" width="450" height="450" />
          <title class="showTextOnHighlight">Title 3</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/music/music_570_e4.lcr" width="450" height="450" />
