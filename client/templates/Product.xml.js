...
<document>
  ...
  <productTemplate theme="light">
    ...
    <shelf>
      ...
      <section>
        <lockup>
          <img src="${this.BASEURL}resources/images/movies/movie_520_e1.lcr" width="150" height="226" />
          <title class="showTextOnHighlight">Title 1</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/movies/movie_520_e2.lcr" width="150" height="226" />
          <title class="showTextOnHighlight">Title 2</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/movies/movie_520_e3.lcr" width="150" height="226" />
          <title class="showTextOnHighlight">Title 3</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/movies/movie_520_e4.lcr" width="150" height="226" />
          <title class="showTextOnHighlight">Title 4</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/movies/movie_520_e5.lcr" width="150" height="226" />
          <title class="showTextOnHighlight">Title 5</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/movies/movie_520_e6.lcr" width="150" height="226" />
          <title class="showTextOnHighlight">Title 6</title>
        </lockup>
        <lockup>
          <img src="${this.BASEURL}resources/images/movies/movie_520_e7.lcr" width="150" height="226" />
