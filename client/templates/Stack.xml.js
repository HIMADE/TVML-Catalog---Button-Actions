...
<document>
  <head>
    <style>
    .greenImageGradient {
      tv-tint-color: linear-gradient(top, 0.37, transparent, 0.57, rgba(0,64,0,0.7), 0.96, rgba(0,64,0,1.0), rgba(0,64,0,1.0));
    }
    .showTextOnHighlight {
  ...
  <stackTemplate>
    <collectionList>
      <carousel>
        <section>
          <lockup>
            <img src="${this.BASEURL}resources/images/carousel/carousel_e3_1740x500.lcr" width="1740" height="500" />
            <overlay>
              <title>Title 1</title>
          ...
          <lockup>
            <img src="${this.BASEURL}resources/images/carousel/carousel_e1_1740x500.lcr" width="1740" height="500" />
            <overlay>
              <title>Title 2</title>
          ...
          <lockup>
            <img src="${this.BASEURL}resources/images/carousel/carousel_e2_1740x500.lcr" width="1740" height="500" />
            <overlay>
              <title>Title 3</title>
      ...
      <shelf>
        ...
        <section>
          <lockup>
            <img src="${this.BASEURL}resources/images/movies/movie_520_e1.lcr" width="332" height="500" />
          ...
          <lockup>
            <img src="${this.BASEURL}resources/images/movies/movie_520_e3.lcr" width="332" height="500" />
            <title class="showTextOnHighlight">Title 3</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/movies/movie_520_e4.lcr" width="332" height="500" />
            <title class="showTextOnHighlight">Title 4</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/movies/movie_520_e5.lcr" width="332" height="500" />
            <title class="showTextOnHighlight">Title 5</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/movies/movie_520_e6.lcr" width="332" height="500" />
            <title class="showTextOnHighlight">Title 6</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/movies/movie_520_e7.lcr" width="332" height="500" />
