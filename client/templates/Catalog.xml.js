          ...
          <listItemLockup>
            ...
            <relatedContent>
              <grid>
                <section>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_570_e1.lcr" width="308" height="308" />
                    <title class="whiteText">Title 1</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_570_e2.lcr" width="308" height="308" />
                    <title class="whiteText">Title 2</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_570_e3.lcr" width="308" height="308" />
                    <title class="whiteText">Title 3</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_570_e4.lcr" width="308" height="308" />
                    <title class="whiteText">Title 4</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_570_e5.lcr" width="308" height="308" />
                    <title class="whiteText">Title 5</title>
                  </lockup>
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_570_e6.lcr" width="308" height="308" />
            ...
            <relatedContent>
              <grid>
                <section>
                  ...
                  <lockup>
                    <img src="${this.BASEURL}resources/images/music/music_570_e7.lcr" width="308" height="308" />
