  ...
  <stackTemplate theme="light" class="lightBackgroundColor" >
    ...
    <collectionList>
      <shelf>
        ...
        <section>
          <lockup>
            <img src="${this.BASEURL}resources/images/music/music_520_e1.lcr" width="390" height="390" />
            <title>Title 1</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/music/music_520_e2.lcr" width="390" height="390" />
            <title>Title 2</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/music/music_520_e3.lcr" width="390" height="390" />
            <title>Title 3</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/music/music_520_e4.lcr" width="390" height="390" />
            <title>Title 4</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/music/music_520_e5.lcr" width="390" height="390" />
            <title>Title 5</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/music/music_520_e6.lcr" width="390" height="390" />
            <title>Title 6</title>
          </lockup>
          <lockup>
            <img src="${this.BASEURL}resources/images/music/music_520_e7.lcr" width="390" height="390" />
            <title>Title 7</title>
          </lockup>
        </section>
      </shelf>
